...
# - image, blurred image (x3), blutted image (x5)
...
def read_log(dir, t="c", cb=0., lrb=0.2):
...
if __name__ == "__main__":
	...
	sk_left_log  = read_log(sk_left_dir,    t = "c l r", cb =  0.4)
	sk_right_log = read_log(sk_right_dir,   t = "c l r", cb = -0.4)
	...
	#for i in range(100):
#		b_train_log, b_train_log_left    = balance(b_train_log, b_train_log_left)
#		print(i, len(b_train_log), len(b_train_log_left))
		#print(np.histogram(np.absolute(b_train_log.steering), bins=BINS-1, range=(0.,1.)))
		#print(np.histogram(np.absolute(b_train_log_left.steering), bins=BINS-1, range=(0.,1.)))
